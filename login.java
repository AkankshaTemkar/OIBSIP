...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==1)
        {
            l.setText("Que2: To which of the following does the class String belong to.");
            jb[0].setText("java.lang");jb[1].setText("java.awt");jb[2].setText("java.applet");jb[3].setText("java.string");
        }
        if(current==2)
        {
            l.setText("Que3: Total constructor string class have?");
            jb[0].setText("3");jb[1].setText("7");jb[2].setText("13");jb[3].setText("20");
        }
        if(current==3)
        {
            l.setText("Que4: Output of Math.floor(3.6)?");
